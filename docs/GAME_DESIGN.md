...
- 코스터 차고: 보유 코스터를 배치해 운영력과 지역 인지도를 키운다.
- 메인 코스터 업그레이드: 50단계 성장, 10개 외형 티어, 단계별 마일스톤 보상을 가진다.
- VIP 손님: 일정 탭마다 등장하는 보너스 이벤트이며, 제한 시간 안에 응대하면 큰 골드를 준다.
- 지역 투자: 지역 지분에 투자해 장기 배당 수익을 얻는 후반 성장 루트다.
...
- 운영 업그레이드는 탭당 골드를 올려 클리커 감각을 키운다.
