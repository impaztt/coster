...
extension AchievementCategoryInfo on AchievementCategory {
  String get label => switch (this) {
        ...
        AchievementCategory.dps => '초당 수익',
        AchievementCategory.playtime => '플레이 시간',
        AchievementCategory.producer => '직원',
        AchievementCategory.coasterCollect => '코스터 수집',
        AchievementCategory.coasterLevel => '코스터 업그레이드',
        AchievementCategory.summon => '도입',
        AchievementCategory.prestige => '재개장',
        AchievementCategory.slime => 'VIP 손님',
        AchievementCategory.combat => '피버',
        AchievementCategory.skill => '이벤트',
        AchievementCategory.daily => '일일',
        AchievementCategory.master => '마스터',
        AchievementCategory.stocks => '지역 투자',
  ...
  IconData get icon => switch (this) {
        ...
        AchievementCategory.slime => Icons.workspace_premium,
